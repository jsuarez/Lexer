...
<!-- Saludos Finales-->
    ...
    <p>
    <input type="text" class="inputbox"  name="txt_reg_SocialReason3" value="Raz&oacute;n Social" /><br />
...
<input name="" type="button" value="Preview" onclick="Recomendarme.mail('sponsor_otrapersona.php');" />
<input name="" type="button" value="Enviar" onclick="Recomendarme.mail('sponsor_otrapersona.php?action=send');" />
