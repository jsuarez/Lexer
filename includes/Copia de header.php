...
<div id="search">
    <form method="post" enctype="text/plain">
        <input type="text" id="txtSearch" value="Nombre..." onfocus="clear_input(event)" onblur="set_input(event, 'Nombre...')" />
...
<div id="advanced_search">
	<div class="button_search"><a href="#" onclick="alert('aaa');slider('advanced_search', 94);return false;">Busqueda Avanzada</a></div>
</div>
